...
**P4.3 设计：** [市场数据可信度与覆盖](./docs/superpowers/specs/2026-09-22-tennixai-p4-market-data-truthfulness-and-coverage-design.md)（T83 已设计冻结，2026-09-22 用户书面确认；T84–T89 按顺序实施，详细计划见 `docs/superpowers/plans/`）。
