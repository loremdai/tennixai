...
- **设计规格：** [T103 比分完整性设计](./docs/superpowers/specs/2026-09-26-tennixai-t103-score-integrity-design.md)；待用户审阅。产品代码尚未修改。
...
| 日期 | 提交 | 事实 |
|---|---|---|
| 2026-09-26 | `1c47cc3` | T103 规格记录真实根因、抢七解码、旧快照按需刷新与跨层验收；用户审阅中，尚未改产品代码。根因原始证据在 `cadc5d0`。 |
