...
| T44 | P2.6 | Add Canonical Ranking Models and the API-Tennis Standings Adapter | `in_progress` | — | 2026-09-12 16:23 CST 由 Claude Code 领取（起始 `91b180c`）；供应商排名字段冻结、canonical ranking、真实 standings smoke |
