...
| P1.2 — Domain and provider | `in_progress` | canonical models、provider protocol、fake/live adapters、进程内 identity | T03（`5ed8a18`）、T04（`20735bd`）已完成；剩余 T05 live adapter、T06 cache |
...
| T05 | P1.2 | Implement the LiveTennisAPI Adapter | `ready` | — | — |
