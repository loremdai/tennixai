...
| T48 | P2.6 | Add the Deterministic PlayerResolver and Cut Runtime Queries to Internal IDs | `in_progress` | — | 2026-09-12 19:02 CST 由 Claude Code 领取（起始 `49c2ce1`）；别名矩阵、上下文消歧、alias→internal ID→provider key |
