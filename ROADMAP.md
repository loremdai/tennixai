...
**当前里程碑：** P3.2 — Safe Foundations（T59 `done`，T60 `in_progress`）

**当前阶段：** P3 — Market & Decision Support（`in_progress`；P3.0/P3.1 已完成，T57–T59 canonical contracts、持久化与只读 Polymarket adapter 已交付）
...
| P3.2 — Market foundation | `in_progress` | canonical contracts、可逆 schema、只读 Polymarket REST/WS、严格 mapping 与 replay | T56–T59 已完成；T60 执行中，完成后 P3.2 关闭 |
...
| T60 | P3.2 | Build the Market WebSocket Reducer, Hot State, and Replay Feed | `in_progress` | — | Claude 已领取（起始 `35b08d9`）；reducer/hash/gap/reconnect、Redis 热状态、确定性 replay 与公开 WS smoke |
