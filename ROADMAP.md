...
**当前里程碑：** P3.2 — Safe Foundations 已完成（T60 `done`，T61 `ready`）

**当前阶段：** P3 — Market & Decision Support（`in_progress`；P3.0–P3.2 已完成，进入 P3.3 预测/决策/paper）
...
| P3.3 — Prediction, decision and paper | `in_progress` | 审计 benchmark、live probability、可执行 quote、decision policy、one-shot paper 与后台双流协调 | T60 完成；T61 已领取执行中，之后按 T62–T65 实施 |
...
| T61 | P3.3 | Add the Audited Walk-Forward Pre-Match Benchmark Pipeline | `in_progress` | — | Claude 已领取（起始 `0dbb0dc`）；数据来源/许可/泄漏 audit、chronological walk-forward、校准与 versioned model card |
