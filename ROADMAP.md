...
|---|---|---|---|
| P1.0 — Design freeze | `in_progress` | 架构路线、原型状态清单、桌面/移动视觉基线 | 架构与计划已落盘；仍需完成 Task 1 的 Playwright 截图基线 |
...
|---|---|---|---|---|---|
| T01 | P1.0 | Freeze the Existing Prototype Visually | `ready` | — | 待建立桌面/移动 Playwright baselines |
