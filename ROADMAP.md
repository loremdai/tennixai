...
| T50 | P2.6 | Route Home and Match Chat Through the Shared Resolver | `in_progress` | — | 2026-09-12 20:16 CST 由 Claude Code 领取（起始 `6114a5c`）；所有 name tools 共用 resolver，ambiguous/not_found 正常 `done` |
