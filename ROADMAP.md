...
| T49 | P2.6 | Expose Rankings, Profile, and Five-Season Result APIs | `in_progress` | — | 2026-09-12 19:35 CST 由 Claude Code 领取（起始 `f3e0161`）；Top 200、完整目录搜索、profile、五赛季分页筛选 |
